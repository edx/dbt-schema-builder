...
"""
dbt-schema-builder documentation build configuration file.
...
#
# html_title = 'dbt-schema-builder v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Automate management of PII redacted schemas for dbt projects.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'dbt_schema_builder'),
                os.path.join(root_path, 'dbt_schema_builder/migrations')])
